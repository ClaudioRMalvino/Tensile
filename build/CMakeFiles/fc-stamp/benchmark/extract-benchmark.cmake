...
#
get_filename_component(filename "/home/claudio/Projects/cpp/Tensile/build/_deps/benchmark-tmp/v1.9.5.zip" ABSOLUTE)
get_filename_component(directory "/home/claudio/Projects/cpp/Tensile/build/_deps/benchmark-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-benchmark${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-benchmark${i}")
