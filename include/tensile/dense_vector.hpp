...
namespace tensile {
    ...
    class DenseVector : private detail::MemStorage<T, Alignment>
    {
    ...
    public:
        ...
        // Default constructor
        explicit DenseVector(): detail::MemStorage<T, Alignment>() {}

        // Size allocation constructor
        explicit DenseVector(const size_t size): detail::MemStorage<T, Alignment>(size) {}

        // List initialization constructor
        DenseVector(std::initializer_list<T> list): detail::MemStorage<T, Alignment>(list.size()) {
